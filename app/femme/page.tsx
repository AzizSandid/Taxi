...
export default function Page() {
  ...
  return (
    <div className="flex flex-col  min-h-screen items-center py-24 bg-white ">
      ...
      {isSmallScreen ? (
        <button onClick={togglePopup} className="p-2 bg-white  hover:bg-slate-200 text-black border border-black-2 rounded-md">
          Show Filter
        </button>
      ) : (
        <div className="  ">
          ...
          <div className="py-8">
            <text className="font-bold text-sm sm:text-base md:text-sm text-black">Marque</text><br />
            <button className="sm:text-base md:text-sm hover:text-gray text-black py-2 ">Adidas</button><br />
            <button className="sm:text-base md:text-sm  hover:text-gray text-black py-2">Nike</button><br />
            <button className="sm:text-base md:text-sm  hover:text-gray text-black py-2">Puma</button><br />
            <button className="sm:text-base md:text-sm  hover:text-gray text-black py-2">New Balance</button><br />
            <button className="sm:text-base md:text-sm  hover:text-gray text-black py-2">Air Jordan 1</button><br />
            <button className="sm:text-base md:text-sm  hover:text-gray text-black py-2">Jordan</button><br />
            <button className="sm:text-base md:text-sm  hover:text-gray text-black py-2 ">McQueen</button>
          </div>
        </div>
      )}
      ...
      {isPopupVisible && (
        <div className="fixed inset-0 bg-black sm:w-1/5 md:w-2/5 p-2 bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-4 rounded-md w-11/12 sm:w-1/2">
            <button onClick={togglePopup} className="float-right p-1 bg-red-700  hover:bg-red-500 text-white rounded-md">
              Close
            </button>
            <p className="font-bold text-base text-black sm:text-xl md:text-2xl">
           Filtre
          ...
          <div className="flex items-center mb-6 sm:mb-2 w-full justify-between">
            ...
            <div className="flex">
              <select name="drop1" id="Select1" className="text-black">
                ...
                <option value="marque">prix</option>
