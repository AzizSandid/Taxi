              ...
              <div className="flex flex-col items-center justify-between py-24">
                <div className="product-detail flex w-4/5 mx-auto mb-12">
                  ...
                  <div className="product-info max-w-lg">
                    <h1 className="text-4xl font-bold mb-4">Air Force 1</h1>
                    <p className="price text-3xl font-bold mb-6">$120.00</p>
                    <div className="sizes flex mb-6">
                      <button className="size border border-gray-300 py-2 px-4 mr-2">
                        S
                      </button>
                      <button className="size border border-gray-300 py-2 px-4 mr-2">
                        M
                      </button>
                      <button className="size border border-gray-300 py-2 px-4">
                        L
                      </button>
                    </div>
                    <div className="colors flex mb-6">
                      {Object.keys(detailsArticle.images).map((color) => (
                        <button
                          key={color}
                          className={`color border border-gray-300 py-2 px-4 mr-2 ${
                    ...
                    <button className="add-to-cart bg-yellow-500 text-white py-3 px-6">
                      Add to Cart
                    </button>
                  </div>
                </div>
                <div className="reviews w-4/5 mx-auto">
                  ...
                  <button className="border border-gray-300 rounded-full py-2 px-4 mb-4">Write a Review</button>
                  <div className="review border-t border-gray-300 py-4">
                    <div className="review-header flex justify-between mb-2">
                      <div className="reviewer-info flex items-center">
                        ...
                        />
                        <div className="reviewer-name font-bold">John Doe</div>
                      </div>
                      <div className="review-date text-gray-500">July 21, 2024</div>
                    </div>
                    <p className="review-text">Great shoes, very comfortable!</p>
                  </div>
                  <div className="review border-t border-gray-300 py-4">
                    <div className="review-header flex justify-between mb-2">
                      <div className="reviewer-info flex items-center">
                        <img
                          ...
                          className="reviewer-image rounded-full mr-2"
                        />
                        <div className="reviewer-name font-bold">Jane Smith</div>
                      </div>
                      <div className="review-date text-gray-500">July 20, 2024</div>
                    </div>
                    <p className="review-text">Stylish and fits well.</p>
                  </div>
                  <div className="review border-t border-gray-300 py-4">
                    <div className="review-header flex justify-between mb-2">
                      <div className="reviewer-info flex items-center">
                        <img
                          ...
                          className="reviewer-image rounded-full mr-2"
                        />
                        <div className="reviewer-name font-bold">Michael Johnson</div>
                      </div>
                      <div className="review-date text-gray-500">July 19, 2024</div>
                    </div>
                    <p className="review-text">A bit tight, but overall good quality.</p>
                  </div>
                </div>
              </div>
            );
