...
export default function Home() {
  ...
  const iconList = [
    {
      ...
      subTitle:
        "Nous proposons de nombreux types de produits différents avec de variations dans chaque catégorie.",
    },
    {
      icon: Commande,
      label: "Livraison Rapide",
      subTitle:
        "Délai de livraison de 7 jours ou moins et option de livraison accélérée.",
    },
    {
      icon: Phone,
  ...
  return (
    <main className="flex min-h-[4100px] flex-col items-center justify-between py-24 bg-white">
      <div
        id="first-section"
        className="flex rounded-3xl h-[350px] w-11/12 bg-primary p-12 pb-0 justify-between"
      >
        <div className="w-full md:w-[55%]">
          <text className="font-extrabold text-2xl sm:text-4xl md:text-5xl text-black h-fit">
            Découvrir Votre Style
          </text>
          <div className="flex my-8 justify-between w-2/3 sm:w-1/2">
            <div>
              <p className="font-medium text-lg sm:text-xl md:text-3xl text-black ">
                50+
              </p>
            ...
            <div>
              ...
              <p className="font-medium text-llg md:text-xl text-black ">
                Clients
              </p>
            </div>
          </div>
        ...
        <img
          src="/homeImage.png"
          alt="Home Image"
          className="place-self-end rounded-t-[200px] rounded-bl-[200px] w-[40%] h-[90%] max-h-[400px] max-w-[370px] hidden md:block"
        />
      </div>
      <div className="flex flex-col md:flex-row w-11/12">
        <div className="w-full md:w-1/4 flex flex-col justify-between h-44 mb-4 md:h-80">
          <p className="font-bold text-xl sm:text-2xl lg:text-3xl text-black">
            Pièces les plus vendues
          </p>
          <p className="font-medium text-base sm:text-base lg:text-xl text-gray w-11/12">
            La meilleure façon de profiter de nos produits les plus populaires
        ...
        <div className="flex flex-wrap justify-center gap-2 w-full md:w-3/4 md:justify-between">
      ...
      <div id="propos" className="flex flex-col w-11/12 items-center">
        ...
        <p className="font-medium text-sm sm:text-base md:text-xl text-gray py-3">
          Commandez maintenant et appréciez la beauté de nos produits
        </p>
        ...
        <div className="flex flex-col space-y-12 w-full bg-primary p-12 items-center justify-center">
          <div className="flex w-3/4 justify-between items-center">
            <div className=" space-y-4 w-2/5 flex items-center flex-col">
              ...
              <p className="font-bold text-center text-sm sm:text-base md:text-lg text-black">
                Homme
              </p>
            </div>
            <div className=" space-y-4 w-2/5 flex items-center flex-col ">
